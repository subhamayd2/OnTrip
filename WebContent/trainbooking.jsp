<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	String t_number = request.getParameter("train_no");
	String t_class = request.getParameter("class_type");
	String from = request.getParameter("train_from");
	String to = request.getParameter("train_to");
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<h3 class="text-center">Train Ticket</h3>
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<h5>Train name :</h5><h4><%=name %></h4>
		</div>
		<div class="col-sm-6">
			<h5>Train number :</h5><h4><%=t_number %></h4>
		</div>
		<div class="col-sm-6">
...
<script src="trainbooking.js"></script>
</body>
</html>
