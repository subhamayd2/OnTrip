...
<%
	...
	String t_number = request.getParameter("bus_no");
	String t_class = request.getParameter("class_type");
	String from = request.getParameter("bus_from");
	String to = request.getParameter("bus_to");
...
<div class="col-sm-12 col-md-6" style="margin-bottom:5px;">
	<form class="form-inline" role="form">
		<div class="form-group">
  		...
  		<input type="hidden" value='<%=t_class %>' id="t_class">
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<h3 class="text-center">Bus Ticket</h3>
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<h5>Bus number :</h5><h4><%=t_number %></h4>
		</div>
		<div class="col-sm-6">
			<h5>License :</h5><h4><%=license %></h4>
		</div>
		<div class="col-sm-6">
